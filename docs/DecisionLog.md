...
- Status: Accepted
- Context: Phase 4 calls for pluggable world generators, but the project does not yet need multiple terrain algorithms, chunking, or broad generator discovery.
